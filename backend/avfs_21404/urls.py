...
admin.site.site_header = "AVFS"
admin.site.site_title = "AVFS Admin Portal"
admin.site.index_title = "AVFS Admin"

# swagger
api_info = openapi.Info(
    title="AVFS API",
    default_version="v1",
    description="API documentation for AVFS App",
)
